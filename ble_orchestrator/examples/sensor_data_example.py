...
async def sensor_data_example(mac_address, service_uuid, characteristic_uuid):
    ...
    try:
        ...
        # センサーデータを取得
        logger.info(f"デバイス {mac_address} からデータを取得中...")
...
def main():
    ...
    loop.run_until_complete(sensor_data_example(mac_address, service_uuid, characteristic_uuid))
